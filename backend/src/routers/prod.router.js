...
var prod_model_1 = require("../models/prod.model");
var admin_mid_1 = require("../middlewares/admin.mid");
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prod_model_1.ProdModel.countDocuments()];
            case 1:
                foodsCount = _a.sent();
                if (foodsCount > 0) {
                ...
                return [4 /*yield*/, prod_model_1.ProdModel.create(data_1.sample_prods)];
            case 2:
                _a.sent();
...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prod_model_1.ProdModel.find()];
            case 1:
                foods = _a.sent();
                res.send(foods);
                return [2 /*return*/];
...
router.post("/", admin_mid_1.default, (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, price, tags, favorite, imageUrl, food;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, price = _a.price, tags = _a.tags, favorite = _a.favorite, imageUrl = _a.imageUrl;
                food = new prod_model_1.ProdModel({
                    name: name,
                    price: price,
...
router.put("/", admin_mid_1.default, (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, name, price, tags, favorite, imageUrl;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, id = _a.id, name = _a.name, price = _a.price, tags = _a.tags, favorite = _a.favorite, imageUrl = _a.imageUrl;
                return [4 /*yield*/, prod_model_1.ProdModel.updateOne({ _id: id }, {
                        name: name,
                        price: price,
                        tags: tags.split ? tags.split(',') : tags,
                        favorite: favorite,
...
router.delete("/:prodId", admin_mid_1.default, (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var prodId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                prodId = req.params.prodId;
                return [4 /*yield*/, prod_model_1.ProdModel.deleteOne({ _id: prodId })];
            case 1:
                _a.sent();
                res.send();
                return [2 /*return*/];
...
router.get("/tags", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, prod_model_1.ProdModel.aggregate([
                    { $unwind: "$tags" },
            ...
            case 1:
                ...
                return [4 /*yield*/, prod_model_1.ProdModel.countDocuments()];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prod_model_1.ProdModel.find({ name: { $regex: searchRegex } })];
            case 1:
                foods = _a.sent();
                res.send(foods);
                return [2 /*return*/];
...
router.get("/tag/:tagName", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prod_model_1.ProdModel.find({ tags: req.params.tagName })];
            case 1:
                foods = _a.sent();
                res.send(foods);
                return [2 /*return*/];
...
router.get("/:foodId", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prod_model_1.ProdModel.findById(req.params.foodId)];
            case 1:
                food = _a.sent();
                res.send(food);
                return [2 /*return*/];
